    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-20">
            <h2 class="text-4xl md:text-5xl font-serif text-gray-900 leading-tight max-w-4xl">
                Just as robotics automated factory floors, <span class="font-semibold">Emerix is now automating supply chain operations.</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center p-8">
                        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                            <div class="flex items-center gap-3 mb-4">
                                <div class="h-8 w-8 bg-[oklch(0.696_0.17_162.48)] rounded flex items-center justify-center text-white">
                                    <Database size={16} />
                                </div>
                                <span class="font-medium text-gray-900">NetSuite ERP</span>
                            </div>
                            <div class="space-y-2">
            ...
            <div class="space-y-12">
                <h3 class="text-2xl font-serif text-gray-900">
                    An Integrated AI Platform <br/> Built for Supply Chain Excellence
                </h3>

                <div class="space-y-8">
                    {#each [
                        { id: '01', title: 'Direct ERP integration', icon: Database },
                        { id: '02', title: 'Transparent, auditable actions', icon: Search },
                        { id: '03', title: 'Autonomous workflow execution', icon: Settings },
                        { id: '04', title: 'Domain-trained AI agents', icon: FileText }
                    ] as feature}
