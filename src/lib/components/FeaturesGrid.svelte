    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-16">
            <h2 class="text-4xl md:text-5xl font-serif text-gray-900 leading-tight">
                AI Trained for Supply Chain<br />Operations Excellence
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 p-8 rounded-lg flex flex-col h-full">
                <h3 class="text-lg font-serif text-gray-900 mb-8">ERP Integration</h3>
                ...
                <p class="text-xs text-gray-500 leading-relaxed mt-auto">
                    Native integration with NetSuite and other ERPs. AI agents execute workflows directly within your systems, no data migration required.
                </p>
            </div>

            <!-- Workflow Templates -->
            <div class="bg-gray-50 p-8 rounded-lg flex flex-col h-full">
                <h3 class="text-lg font-serif text-gray-900 mb-8">Workflow Templates</h3>
                <div class="flex-1 flex items-center justify-center mb-8">
                ...
                <p class="text-xs text-gray-500 leading-relaxed mt-auto">
                    Pre-built workflows for common supply chain operations: procurement, inventory management, demand planning, and supplier coordination.
                </p>
            </div>

            <!-- Four-Week Deployment -->
            <div class="bg-gray-50 p-8 rounded-lg flex flex-col h-full">
                <h3 class="text-lg font-serif text-gray-900 mb-8">Four-Week Deployment</h3>
                <div class="flex-1 flex items-center justify-center mb-8">
                    <div class="flex -space-x-2">
                        <div class="h-10 w-10 rounded-full bg-blue-100 border-2 border-white flex items-center justify-center text-blue-600 text-xs">1</div>
                        <div class="h-10 w-10 rounded-full bg-green-100 border-2 border-white flex items-center justify-center text-green-600 text-xs">2</div>
                        <div class="h-10 w-10 rounded-full bg-purple-100 border-2 border-white flex items-center justify-center text-purple-600 text-xs">3</div>
                    </div>
                </div>
                <p class="text-xs text-gray-500 leading-relaxed mt-auto">
                    Live workflows in four weeks. Our supply chain experts guide you from integration to autonomous operations with proven deployment methodology.
                </p>
            </div>

            <!-- Domain-Trained AI -->
            <div class="bg-gray-50 p-8 rounded-lg flex flex-col h-full">
                <h3 class="text-lg font-serif text-gray-900 mb-8">Domain-Trained AI</h3>
                <div class="flex-1 flex items-center justify-center mb-8">
                    <div class="relative">
                ...
                <p class="text-xs text-gray-500 leading-relaxed mt-auto">
                    AI agents trained specifically for supply chain operations, understanding manufacturing workflows, inventory dynamics, and procurement processes.
                </p>
            </div>
